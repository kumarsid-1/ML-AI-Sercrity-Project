...
def iris_pipeline():
    """
    Train Iris classifier and detect drift with ADWIN.

    Returns:
        dict summary with baseline accuracy, KS stat/p, PSI,
        and ADWIN detection info.
    """
    ...
    try:
        ...
        logger.info(f"Stream length: {len(stream)}; drift starts at index {drift_start}")
